...
#         api_data = res.json()
#         mock_response = api_data.get("answer", "답변을 불러오지 못했습니다.")
#         sources = api_data.get("sources", [])
#     else:
#         mock_response = f"API 서버 오류가 발생했습니다. 상태 코드: {res.status_code}"
#         sources = []

# except requests.exceptions.ConnectionError:
#     mock_response = "API 서버에 연결할 수 없습니다. 먼저 FastAPI 서버를 실행해주세요."
#     sources = []

# except Exception as e:
#     mock_response = f"오류가 발생했습니다: {e}"
#     sources = []
